...
RUN dnf update -y
RUN dnf install psmisc which vim curl git gvim gcc gcc-c++ cmake make gnutls-devel libuuid-devel -y
...
RUN pip3 install git+git://github.com/robgolding63/tasklib@develop
